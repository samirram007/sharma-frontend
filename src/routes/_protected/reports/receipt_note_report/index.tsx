import ReceiptNoteReport from '@/features/modules/voucher/receipt_note_report'
import { receiptNoteReportQueryOptions } from '@/features/modules/voucher/receipt_note_report/data/queryOptions'
import type { ReceiptNoteReportParams } from '@/features/modules/voucher/receipt_note_report/data/api'
...
export const Route = createFileRoute(
  ...
  component: () => {
    ...
    const params: ReceiptNoteReportParams = {
      page,
      per_page: perPage,
