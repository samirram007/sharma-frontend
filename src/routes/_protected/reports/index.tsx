...
const headlineCards = [
  {
    title: 'Day Book',
    description:
      'Track posting flow and verify voucher chronology for the day.',
    to: '/reports/day_book',
    icon: BookOpen,
    tag: 'Operations',
  },
  {
    title: 'Stock Summary',
    description:
      'Monitor stock position across item, zone, godown, and voucher views.',
  ...
  },
  {
    ...
    description:
      'Review freight cost movement by transporter, godown, and voucher.',
    to: '/reports/freight',
    icon: Truck,
    tag: 'Logistics',
  },
      ...
      <section className="overflow-hidden rounded-2xl border bg-card">
        <div className="bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.16),transparent_40%),radial-gradient(circle_at_85%_0%,rgba(37,99,235,0.14),transparent_35%)] p-6 sm:p-8">
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground sm:text-base">
            Explore operational, inventory, logistics, and finance reports from
            one place. Use the focused report topics below to jump directly into
