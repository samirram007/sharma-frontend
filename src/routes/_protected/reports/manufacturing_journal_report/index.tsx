import ManufacturingJournalReport from '@/features/modules/voucher/manufacturing_journal_report'
import { manufacturingJournalReportQueryOptions } from '@/features/modules/voucher/manufacturing_journal_report/data/queryOptions'
import type { ManufacturingJournalReportParams } from '@/features/modules/voucher/manufacturing_journal_report/data/api'
...
export const Route = createFileRoute(
  '/_protected/reports/manufacturing_journal_report/',
)({
  component: () => {
    const [page, setPage] = useState(1)
    const [perPage, setPerPage] = useLocalStorage<number>('manufacturing_journal_report_per_page', 10)
    ...
    const {
      ...
      error,
      refetch,
    } = useQuery(manufacturingJournalReportQueryOptions(params))
        ...
        <div className="flex flex-col items-center justify-center h-64 gap-4">
          <div className="flex items-center gap-2 text-destructive">
            ...
            <span className="text-lg font-semibold">
              Error loading manufacturing journal report
            </span>
          </div>
