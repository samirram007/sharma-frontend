...
import FreightTransporterWise from '@/features/modules/voucher/freight/transporter-wise'
...
export const Route = createFileRoute(
    ...
    loader: ({ context }) =>
        context.queryClient.ensureQueryData(freightReportQueryOptions('transporter_wise')),
    component: () => {
        const { data: freightTransporterWise } = useSuspenseQuery(freightReportQueryOptions('transporter_wise'))
        return <FreightTransporterWise data={freightTransporterWise?.data} />
    },
