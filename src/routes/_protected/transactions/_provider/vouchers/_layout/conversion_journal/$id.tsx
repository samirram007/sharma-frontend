...
export const Route = createFileRoute(
    ...
    loader: ({ context, params: { id } }) => {
        ...
        return context.queryClient.ensureQueryData(ConversionJournalQueryOptions(id))
    },
    component: RouteComponent,
    errorComponent: () => (
        <div>
            <span className='bg-red-400'>By ID:</span> Error loading conversion journal.
        </div>
    ),
...
function RouteComponent() {
    ...
    const { data: conversionJournal } = useSuspenseQuery(ConversionJournalQueryOptions(id))
    return (
