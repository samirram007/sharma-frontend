...
export const reportLinks = [
  {
    ...
    icon: IconBook,
    description:
      'View daily transaction summaries, receipts, and distributor activity',
    visible: true,
    menus: [
      {
        title: 'Day Book',
      ...
      },
      {
        ...
        icon: IconFileText,
        href: '/reports/receipt_note_report',
        visible: true,
        isActive: false,
        disabled: false,
      },            {
                ...
                href: '/reports/manufacturing_journal_report',
                visible: true,
                isActive: false,
                disabled: false,
            },
            {
                ...
                icon: IconBuildingFactory,
                href: '/reports/conversion_journal_report',
                visible: true,
                isActive: false,
                disabled: false,
            },
  ...
  },
  {
    ...
    icon: IconPackages,
    description:
      'Analyze stock-in-hand across items, godowns, zones, vouchers, and batches',
    visible: true,
    menus: [
      {
  ...
  },
  {
    ...
    icon: IconTruck,
    description:
      'Track freight costs, delivery notes, and transporter/vehicle performance',
    visible: true,
    menus: [
      {
      ...
      },
      {
        ...
        icon: IconTruck,
        href: '/reports/freight/freight-transporter-item-wise',
        visible: true,
        isActive: false,
        disabled: false,
      },
