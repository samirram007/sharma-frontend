                                    ...
                                    <Link
                                      ...
                                      className={cn(
                                        ...
                                        location.pathname === item.href
                                          ...
                                          : 'font-normal text-slate-700 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-300 hover:bg-slate-100 dark:hover:bg-slate-800/50',
                                      )}
                                    >
                                      {item.icon && (
                                        <item.icon
