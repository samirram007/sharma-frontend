  ...
  return (
    <>
      <div className='lg:hidden'>
        <DropdownMenu modal={false}>
          ...
          <DropdownMenuContent side='bottom' align='start'>
            {links.filter(link => link.visible).map(({ title, href, isActive, icon: Icon }) => (
      ...
      <nav
        ...
        {...props}
      >
        {links.filter(link => link.visible).map(({ hasSubmenu, submenuItems, title, href, isActive, icon: Icon }) => (
          hasSubmenu ?
