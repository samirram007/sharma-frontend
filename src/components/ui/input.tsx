...
function Input({
  ...
  return (
    ...
    >
      <InputPrimitive
        className={cn(
          'h-12 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-none placeholder:text-muted-foreground/64',
          size === 'sm' &&
            'h-11 px-[calc(--spacing(2.5)-1px)] py-[calc(--spacing(1)-1px)]',
          size === 'lg' && 'h-14 py-[calc(--spacing(2)-1px)]',
          props.type === 'search' &&
