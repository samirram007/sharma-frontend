...
const sidebarNavItems = [
    {
        title: 'Employee',
        description: 'Manage employee profiles, joining details, and assigned designations.',
        visible: true,
    ...
    },
    {
        ...
        description: 'Cluster employees by shared policies, pay structure, or employment type.',
        visible: true,
    ...
    {
        title: 'Department',
        description: 'Define organisational departments and their reporting structure.',
        visible: true,
    ...
    {
        title: 'Grade',
        description: 'Configure pay grades and seniority levels used in payroll calculation.',
        visible: true,
