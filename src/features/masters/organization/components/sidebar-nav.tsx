...
export default function SidebarNav({
  ...
  return (
    <>
      ...
      <ScrollArea className="hidden w-full min-w-56 rounded-xl border border-slate-200/80 bg-linear-to-b from-white via-slate-50 to-slate-100/80 px-2 py-2 shadow-sm dark:border-white/[0.08] dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 md:block">
        <nav
          className={cn(
