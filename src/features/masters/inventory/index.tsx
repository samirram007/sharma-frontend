...
const sidebarNavItems = [
    {
        title: 'Stock Item',
        description: 'Register individual goods, materials, and finished products for tracking.',
        visible: true,
    ...
    {
        title: 'Stock Group',
        description: 'Organise stock items into manageable product families and groups.',
        visible: true,
    ...
    },
    {
        ...
        description: 'Apply category labels to classify inventory for reporting and filtering.',
        visible: true,
    ...
    {
        title: 'Stock Unit',
        description: 'Define units of measurement applied across stock items and transactions.',
        visible: true,
    ...
    },
    {
        ...
        description: 'Map standard UQC codes to units for statutory compliance reporting.',
        visible: true,
