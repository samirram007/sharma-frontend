...
const sidebarNavItems = [
  {
    title: 'User',
    description:
      'Create and manage system user accounts and login credentials.',
  ...
  },
  {
    title: 'Roles',
    description:
      'Define role profiles that bundle permissions for user assignment.',
  ...
  },
  {
    ...
    description:
      'Assign granular access permissions to roles across all modules.',
  ...
  },
  {
    title: 'App Module',
    description:
      'Register and configure application modules available in the system.',
  ...
  },
  {
    title: 'App Features',
    description:
      'Define feature flags and sub-capabilities available per module.',
