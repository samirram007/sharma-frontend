  ...
  const sections = [
    {
      title: 'Organization',
      description:
        'Configure company profile, fiscal years, currencies, countries and states.',
      ...
      tone: {
        ...
        badge:
          'border-cyan-200/80 bg-cyan-100/80 text-cyan-700 dark:border-cyan-900/70 dark:bg-cyan-950/50 dark:text-cyan-300',
    ...
    },
    {
      title: 'Accounts',
      description:
        'Set up account nature, groups, ledgers and voucher configurations.',
      ...
      tone: {
        ...
        badge:
          'border-emerald-200/80 bg-emerald-100/80 text-emerald-700 dark:border-emerald-900/70 dark:bg-emerald-950/50 dark:text-emerald-300',
    ...
    },
    {
      title: 'Party',
      description:
        'Manage suppliers, distributors and transporters with linked ledger data.',
      ...
      tone: {
        ...
        badge:
          'border-rose-200/80 bg-rose-100/80 text-rose-700 dark:border-rose-900/70 dark:bg-rose-950/50 dark:text-rose-300',
    ...
    },
    {
      title: 'Inventory',
      description:
        'Configure stock items, groups, categories, units, godowns and storage.',
      ...
      tone: {
        ...
        badge:
          'border-amber-200/80 bg-amber-100/80 text-amber-700 dark:border-amber-900/70 dark:bg-amber-950/50 dark:text-amber-300',
    ...
    },
    {
      title: 'Payroll',
      description:
        'Maintain employee, department, designation and shift master records.',
      ...
      tone: {
        ...
        badge:
          'border-violet-200/80 bg-violet-100/80 text-violet-700 dark:border-violet-900/70 dark:bg-violet-950/50 dark:text-violet-300',
    ...
    },
    {
      title: 'Statutory',
      description:
        'Maintain statutory codes and tax-related master references.',
      ...
      tone: {
        ...
        badge:
          'border-teal-200/80 bg-teal-100/80 text-teal-700 dark:border-teal-900/70 dark:bg-teal-950/50 dark:text-teal-300',
    ...
    },
    {
      title: 'Miscellaneous',
      description:
        'Manage delivery places, delivery routes, and delivery vehicle setup.',
      ...
      tone: {
        ...
        badge:
          'border-fuchsia-200/80 bg-fuchsia-100/80 text-fuchsia-700 dark:border-fuchsia-900/70 dark:bg-fuchsia-950/50 dark:text-fuchsia-300',
    ...
    <Main className="min-w-0 w-full px-2 py-4 sm:px-2 md:px-2 lg:px-2" fixed>
      <div className="relative overflow-hidden rounded-xl border border-slate-200/70 bg-linear-to-r from-white via-slate-50 to-blue-50/70 p-5 shadow-sm dark:border-white/[0.07] dark:from-slate-950/70 dark:via-slate-950/60 dark:to-blue-950/20">
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
          Central configuration hub for business masters. Choose a section to
          manage setup data.
        </p>
      </div>
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 xl:grid-cols-2">
        {sections.map((section) => (
          ...
          >
            <div
              className={`mb-3 inline-flex rounded-lg border p-2.5 ${section.tone.badge}`}
            >
              {section.icon}
            </div>
            ...
            <div
              className={`pointer-events-none absolute inset-x-0 bottom-0 h-1 bg-linear-to-r ${section.tone.line} opacity-70`}
            />
          </Link>
        ))}
      </div>
