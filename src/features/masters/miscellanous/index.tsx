import { IconBox, IconBuildingWarehouse, IconRuler2 } from '@tabler/icons-react'
...
const sidebarNavItems = [
  {
    ...
    description:
      'Define and manage delivery places for efficient logistics and transportation.',
    visible: true,
  ...
  },
  {
    ...
    description:
      'Plan and manage delivery routes for efficient logistics and transportation.',
    visible: true,
  ...
  },
  {
    ...
    description:
      'Define and manage the fleet of vehicles used for deliveries, including their specifications and maintenance schedules.',
    visible: true,
