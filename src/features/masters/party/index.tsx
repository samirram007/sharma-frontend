...
const sidebarNavItems = [
  {
    ...
    visible: true,
    description:
      'Maintain distributor records, contacts, and linked ledger setup.',
  ...
  },
  {
    ...
    visible: true,
    description:
      'Manage supplier profiles, tax details, and address information.',
    icon: <IconUser size={18} />,
  ...
  },
  {
    ...
    visible: true,
    description:
      'Configure transporter contacts, licensing, and movement details.',
    icon: <IconUser size={18} />,
