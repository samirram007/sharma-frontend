...
const sidebarNavItems = [
    {
        ...
        description: 'Define root-level nature types used to classify all ledger accounts.',
        visible: true,
    ...
    {
        title: 'Account Group',
        description: 'Organise ledger accounts into structured groups for financial reporting.',
        visible: true,
    ...
    {
        title: 'Voucher Type',
        description: 'Configure voucher types that drive transaction and journal entry flows.',
        visible: true,
    ...
    },
    {
        ...
        description: 'Group voucher types into broader operational workflow categories.',
        visible: true,
    ...
    },
    {
        ...
        description: 'Apply classification labels to segment and filter vouchers in reports.',
        visible: true,
