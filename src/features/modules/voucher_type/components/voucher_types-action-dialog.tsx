...
export function VoucherTypesActionDialog({ currentRow, open, onOpenChange }: Props) {
  ...
  const form = useForm<VoucherTypeForm>({
    ...
    defaultValues: isEdit
      ? {
        ...
        voucherClassificationId: currentRow.voucherClassificationId ?? undefined,
  ...
  const onSubmit = (values: VoucherTypeForm) => {
    const formattedValues = {
      ...
      voucherClassificationId: values.voucherClassificationId ? Number(values.voucherClassificationId) : undefined,
    }
    form.reset()
