...
export default function FiscalYearClose() {
  ...
  const { id } = useParams({
    from: '/_protected/masters/organization/_layout/fiscal_year/_layout/$id/close',
  })
    ...
    return (
      <Main className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center space-y-4">
          <IconX className="h-12 w-12 text-destructive mx-auto" />
          <p className="text-lg font-medium text-destructive">
            Failed to load closing preview
          </p>
        ...
        <>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="transition-shadow hover:shadow-md">
              <CardHeader className="pb-2">
                <CardTitle className="text-2xl font-bold">
                  {preview.totalLedgersWithBalance}
                </CardTitle>
          ...
          <Card className="border-amber-500/30 bg-amber-50/50 dark:bg-amber-950/10">
            <CardHeader>
              ...
              <CardDescription>
                Closing a fiscal year is irreversible. All P&amp;L balances will
                be transferred to the Capital account, and stock quantities will
                be frozen. Make sure all vouchers for this year are finalized.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  This fiscal year has already been closed. You can reopen it if
                  needed.
                </CardDescription>
              </div>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              <p>
                This action will <strong>close</strong> the fiscal year and
                perform the following:
              </p>
              <ul className="list-disc pl-5 text-sm space-y-1">
                <li>
                  Create a Closing Account voucher (P&amp;L → Capital transfer)
                </li>
                <li>
                  Create a Closing Stock voucher (freeze stock quantities)
                </li>
                <li>
                  Mark the fiscal year as <strong>inactive</strong>
                </li>
              </ul>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              ...
              <ul className="list-disc pl-5 text-sm space-y-1">
                ...
                <li>
                  Restore the fiscal year to <strong>active</strong> status
                </li>
              </ul>
              <p className="font-medium text-foreground">
                Ensure no opening entries have been created in the next fiscal
                year before reopening.
              </p>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
