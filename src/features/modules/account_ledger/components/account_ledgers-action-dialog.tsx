...
import {
  formSchema,
  type AccountLedger,
  type AccountLedgerForm,
} from '@/features/modules/account_ledger/data/schema'
...
export function AccountLedgersActionDialog({
  currentRow,
  open,
  onOpenChange,
}: Props) {
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader className="text-left">
          <DialogTitle>
            {isEdit ? 'Edit Account Ledger' : 'Add New Account Ledger'}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? 'Update the account ledger here. '
              : 'Create new account ledger here. '}
