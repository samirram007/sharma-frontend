                        ...
                        <div className='grid grid-cols-1 items-start gap-5'>
                            <section className='min-w-0 space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 shadow-sm dark:border-white/8 dark:bg-card'>
                                <div className='space-y-1'>
                                    ...
                                    <p className='text-xs text-slate-500 dark:text-slate-400'>Primary employee identity and personal profile details.</p>
                                </div>
                            ...
                            <section className="min-w-0 space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 shadow-sm dark:border-white/8 dark:bg-card">
                                <div className='space-y-1'>
                                    ...
                                    <p className='text-xs text-slate-500 dark:text-slate-400'>Department, designation, payroll grouping, and account settings.</p>
                                </div>
