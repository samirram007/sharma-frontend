                            ...
                            <div className='space-y-4 sm:space-y-5'>
                                <section className='space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6'>
                                    <div className='space-y-1'>
                                        ...
                                        <p className='text-xs text-slate-500 dark:text-slate-400'>Core supplier identity and statutory details used in purchasing and ledger mapping.</p>
                                    </div>
                                ...
                                <section className='space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6'>
                                    <div className='space-y-1'>
                                        ...
                                        <p className='text-xs text-slate-500 dark:text-slate-400'>Primary contact details for supplier communication and follow-up.</p>
                                    </div>
                                    <div className='space-y-4'>
                            ...
                            <div className='space-y-4 sm:space-y-5'>
                                ...
                                <section className='space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6'>
                                    <div className='space-y-1'>
                                        ...
                                        <p className='text-xs text-slate-500 dark:text-slate-400'>Attach the supplier to the right account group and control whether the record is active.</p>
                                    </div>
                                    <div className='space-y-4'>
