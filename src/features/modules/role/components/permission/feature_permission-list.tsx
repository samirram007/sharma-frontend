    ...
    <Command className=" max-h-[70vh] w-full overflow-hidden ">
      ...
      <CommandList className="max-h-full grid grid-cols-[1fr_1fr] gap-4 p-4">
        ...
        {data?.map((feature: any) => (
          ...
          >
            <div className="text-md font-bold">{feature.code}</div>
              ...
              {feature.rolePermission ? (
                <>
                  {feature.rolePermission.isAllowed ? (
                    <Badge
                      variant={'outline'}
                      className=" animate-fade-in duration-500 border-2 border-green-600 text-green-600"
                    >
                      Granted
                    </Badge>
                  ) : (
                    <Badge
                      variant={'outline'}
                      className=" animate-fade-in duration-500 border-2 border-red-600 text-red-600"
                    >
                      Denied
                    </Badge>
                  )}
                  <PermissionDropDown
                    rolePermission={feature.rolePermission}
                ...
                <>
                  <Badge
                    variant={'outline'}
                    className="animate-in-out duration-100 border-2 border-red-600 text-red-600"
                  >
                    Not Opted
                  </Badge>
                  <PermissionDropDown
