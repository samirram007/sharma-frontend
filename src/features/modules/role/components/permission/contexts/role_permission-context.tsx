...
type RolePermissionDialogType =
  'invite' | 'add' | 'edit' | 'delete' | 'permissions'
...
const RolePermissionContext =
  React.createContext<RolePermissionContextType | null>(null)
...
export const useRolePermission = () => {
  ...
  if (!rolepermissionContext) {
    throw new Error(
      'useRolePermission has to be used within <RolePermissionContext>',
    )
  }
