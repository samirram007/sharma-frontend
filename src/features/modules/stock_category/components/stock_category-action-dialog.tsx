...
export function StockCategoryActionDialog({
  currentRow,
  open,
  onOpenChange,
}: Props) {
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader className="text-left border-b-2 pb-2">
          <DialogTitle>
            {isEdit ? 'Edit Stock Category' : 'Add New Stock Category'}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? 'Update the stock category here. '
              : 'Create new stock category here. '}
