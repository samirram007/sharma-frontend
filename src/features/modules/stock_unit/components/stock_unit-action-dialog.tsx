...
export function StockUnitActionDialog({
  currentRow,
  open,
  onOpenChange,
}: Props) {
  ...
  const form = useForm<StockUnitForm>({
    ...
    defaultValues: isEdit
      ? {
          ...currentRow,
          isEdit,
          status: currentRow?.status as 'active' | 'inactive',
        }
      : {
          unitType: 'simple',
          name: '',
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader className="text-left border-b-2 pb-2">
          <DialogTitle>
            {isEdit ? 'Edit Stock Unit' : 'Add New Stock Unit'}
          </DialogTitle>
          <DialogDescription>
            {isEdit
              ? 'Update the Stock Unit here. '
              : 'Create new Stock Unit here. '}
                  ...
                  <div className="grid grid-rows-2">
                    ...
                    <div className="grid grid-cols-[1fr_100px_1fr] gap-2 ">
                      ...
                      <FormInputField
                        type="number"
                        gapClass={
                          'grid grid-cols-[20px_1fr] gap-x-0   justify-start '
                        }
                        form={form}
