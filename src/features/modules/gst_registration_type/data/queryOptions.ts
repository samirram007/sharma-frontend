...
import {
  fetchGstRegistrationTypeByIdService,
  fetchGstRegistrationTypeService,
  storeGstRegistrationTypeService,
  updateGstRegistrationTypeService,
} from './api'
...
export const gstRegistrationTypeQueryOptions = (id?: number) => {
  return queryOptions({
    ...
    queryFn: () =>
      id
        ? fetchGstRegistrationTypeByIdService(id)
        : fetchGstRegistrationTypeService(),
