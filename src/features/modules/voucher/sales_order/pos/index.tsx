...
function DateBox({
  ...
  form: UseFormReturn<SalesOrderVoucherForm>
  name: 'voucherDate'
}) {
...
const Pos = ({ currentRow }: SalesOrderProps) => {
  ...
  const { mutate: saveSalesOrder, isPending: isSaving } =
    useSalesOrderVoucherMutation()
  ...
  const mainForm = useForm<SalesOrderVoucherForm>({
    resolver: zodResolver(
      salesOrderFormSchema,
    ) as Resolver<SalesOrderVoucherForm>,
    defaultValues:
      isEdit && currentRow
            ...
            {canShowItems ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-slate-500 mb-4">
                  Please select both{' '}
                  <span className="font-medium">Customer</span> and{' '}
                  <span className="font-medium">Sales Account</span> to begin
                  entry.
                </p>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-600">Sales A/c:</span>
                    <span className="text-sm text-slate-400">
                      Select sales account from dropdown
                    </span>
                  </div>
                </div>
              </div>
