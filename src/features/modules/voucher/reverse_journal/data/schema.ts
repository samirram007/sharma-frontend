...
export const reverseJournalVoucherListSchema = z.array(reverseJournalVoucherSchema)
export type ReverseJournalVoucherList = z.infer<typeof reverseJournalVoucherListSchema>
