...
export const PhysicalStockVoucherListSchema = z.array(
  PhysicalStockVoucherSchema,
)
export type PhysicalStockVoucherList = z.infer<
  typeof PhysicalStockVoucherListSchema
>

export const PhysicalStockFormSchema = PhysicalStockVoucherSchema.extend({
