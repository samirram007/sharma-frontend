...
import { CONTRA_VOUCHER_TYPE_ID, contraVoucherListSchema, type ContraForm } from "./schema"
...
export const contraVoucherQueryOptions = () => {
    return queryOptions({
        ...
        queryFn: async () => {
            ...
            return parsed.filter((voucher) => voucher.voucherTypeId === CONTRA_VOUCHER_TYPE_ID)
        },
        staleTime: 1000 * 60,
        retry: 1,
    })
