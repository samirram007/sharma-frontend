...
export default function StockInHandItemWise({
  data: stockInHandItemWiseListSchema,
}: StockInHandItemWiseProps) {
  return (
    <>
                      ...
                      <div className="grid grid-cols-2">
                        <div className="text-right pr-2">
                          {godown.openingQuantity === 0
                            ? '-'
                            : formatQty(godown.openingQuantity, item.noOfDecimalPlaces, item.unitCode)}
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-2">
                        <div className="text-right pr-2">
                          {godown.inwardQuantity === 0
                            ? '-'
                            : formatQty(godown.inwardQuantity, item.noOfDecimalPlaces, item.unitCode)}
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-2">
                        <div className="text-right pr-2">
                          {godown.outwardQuantity === 0
                            ? '-'
                            : formatQty(godown.outwardQuantity, item.noOfDecimalPlaces, item.unitCode)}
                        </div>
                        <div>
