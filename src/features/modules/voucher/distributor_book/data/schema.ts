...
export type DistributorBookDetailsSchema = z.infer<
  typeof distributorBookDetailsSchema
>

export const distributorBookDetailsListSchema = z.array(
  distributorBookDetailsSchema,
)
export type DistributorBookDetailsList = z.infer<
  typeof distributorBookDetailsListSchema
>
