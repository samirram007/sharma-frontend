...
export const conversionJournalReportSchema = voucherSchema.extend({
...
export type ConversionJournalReportSchema = z.infer<
  typeof conversionJournalReportSchema
>

export const conversionJournalReportListSchema = z.array(
  conversionJournalReportSchema,
)
export type ConversionJournalReportList = z.infer<
  typeof conversionJournalReportListSchema
>
