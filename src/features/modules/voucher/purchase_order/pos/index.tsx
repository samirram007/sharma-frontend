...
const Pos = ({ currentRow }: PurchaseOrderProps) => {
    ...
    const { mutate: savePurchaseOrder, isPending: isSaving } = usePurchaseOrderVoucherMutation()
    ...
    const mainForm = useForm<PurchaseOrderVoucherForm>({
        resolver: zodResolver(purchaseOrderFormSchema) as Resolver<PurchaseOrderVoucherForm>,
        defaultValues:
            isEdit && currentRow
                ...
                >
                    <div className='border-b border-slate-300 px-3 py-2 space-y-2'>
                        <div className='flex items-center justify-between'>
                            <h2 className='text-base font-semibold text-slate-800'>Purchase Order</h2>
