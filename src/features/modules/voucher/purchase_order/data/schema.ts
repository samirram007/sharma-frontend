...
export const purchaseOrderVoucherListSchema = z.array(
  purchaseOrderVoucherSchema,
)
export type PurchaseOrderVoucherList = z.infer<
  typeof purchaseOrderVoucherListSchema
>
