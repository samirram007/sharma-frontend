...
import {
  ...
  FreightCalculator,
  DateBox,
} from '../shared/freight-calculator'
...
const VoucherDispatchDetail02 = (props: VoucherDispatchDetailFormProps) => {
  ...
  const actionRowClass =
    'grid w-full grid-cols-[180px_minmax(0,1fr)_42px] items-center gap-4'
        ...
        <DialogContent className="sm:max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
          <DialogHeader className="border-b border-slate-200 pb-3 dark:border-slate-700">
            ...
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              Fill in the dispatch and freight details below, then click Save to
              apply.
            </p>
          </DialogHeader>
          <div
                        ...
                        <div className="space-y-4">
                          <div className={pairRowClass}>
                            <div className={actionRowClass}>
                              <Label className="whitespace-nowrap text-sm font-medium text-slate-600 dark:text-slate-400">
                                Transporter
                              </Label>
                              <TransporterSelector
                                name="carrierName"
          ...
          <DialogFooter className="border-t border-slate-200 px-6 py-3 dark:border-slate-700">
            <Button
              ...
              disabled={
                isPending ||
                !voucherDispatchForm.watch('totalFare') ||
