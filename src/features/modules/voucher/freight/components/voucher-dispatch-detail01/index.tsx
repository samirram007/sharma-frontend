import { Calculator, FileText, LayoutGrid, List, Loader, MapPin, Truck, Info, Car, Settings } from "lucide-react"
                                    ...
                                    {config.find((c) => c.key === 'transport_details')?.value && (
                                        <TabsContent value="transport" className="mt-0 space-y-5">
                                            <SectionCard icon={Truck} title="Transport Details">
                                                <div className="space-y-3">
                                                    <div className="grid grid-cols-1 gap-x-8 gap-y-3 sm:grid-cols-2">
                                                        <FormInputField type='text' gapClass={gapClass02} form={voucherDispatchForm} name='carrierName' label='Carrier / Transporter Name' />
