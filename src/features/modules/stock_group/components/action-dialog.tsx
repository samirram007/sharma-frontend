...
export function ActionDialog({ currentRow, open, onOpenChange }: Props) {
  ...
  const onSubmit = (values: StockGroupForm) => {
    ...
    saveStockGroup(currentRow ? { ...values, id: currentRow.id } : values)
    onOpenChange(false)
  }
    ...
    >
      <DialogContent className="sm:max-w-lg">
        <DialogHeader className="text-left border-b-2 pb-2">
          ...
          <DialogDescription>
            {isEdit
              ? 'Update the Stock Group here. '
              : 'Create new Stock Group here. '}
          ...
          <Form {...form}>
            ...
            >
              ...
              <FormInputField
                type="checkbox"
                form={form}
                name="shouldQuantitiesOfItemsBeAdded"
                label="Should quantities of items be added to stock group?"
                options={[
