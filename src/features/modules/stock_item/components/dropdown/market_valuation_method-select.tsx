...
import {
  MarketValuationMethodLabelSchema,
  type MarketValuationMethod,
} from '@/features/enums/market_valuation_method'
          ...
          >
            ...
            <div className="w-full flex gap-2 flex-row items-center justify-start  space-y-1">
              <SelectDropdown
                ...
                items={(
                  (marketValuationMethods ?? []) as MarketValuationMethod[]
                ).map((marketValuationMethod: MarketValuationMethod) => ({
                  label:
                    MarketValuationMethodLabelSchema.get(
