...
const EmployeeGroupContext =
  React.createContext<EmployeeGroupContextType | null>(null)
...
export const useEmployeeGroup = () => {
  ...
  if (!employeeGroupContext) {
    throw new Error(
      'useEmployeeGroup has to be used within <EmployeeGroupContext>',
    )
  }
