  ...
  return (
    <Dialog>
              ...
              <div className="space-y-4 sm:space-y-5">
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Core distributor identity and tax details used in sales
                ...
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Store the primary distributor contact details used for
                      order coordination.
                    </p>
                  </div>
                  <div className="space-y-4">
              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Link the distributor to the correct account group and
                      control record activity.
                    </p>
                  </div>
                  <div className="space-y-4">
      ...
      <DialogFooter className="ml-0 mr-auto w-full max-w-3xl border-t border-slate-200/70 pt-4 sm:justify-start dark:border-white/[0.07]">
        <Button
          type="submit"
          className="self-center focus:bg-black focus:text-white"
          form="user-form"
          disabled={isPending}
        >
