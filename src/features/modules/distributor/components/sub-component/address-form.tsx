...
const AddressForm = (props: FormProps) => {
    const { form, labelLayoutClass } = props as FormProps;
    ...
    return (
        <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/[0.06]">
            <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Registered address and location details for distributor communication and billing.</p>
            </div>
