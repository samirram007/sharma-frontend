...
interface RoleSelectorProps {
  ...
  rolePermissionCounts?: Map<number, { granted: number; denied: number; total: number }>
}

export function RoleSelector({ roles, selectedRoleId, onSelect, rolePermissionCounts }: RoleSelectorProps) {
  return (
