...
import {
  storeAccountGroupService,
  updateAccountGroupService,
} from '@/features/masters/accounts/services/apis'
import {
  formSchema,
  type AccountGroup,
} from '@/features/modules/account_group/data/schema'
...
export function AccountGroupActionDialog({
  currentRow,
  open,
  onOpenChange,
}: Props) {
