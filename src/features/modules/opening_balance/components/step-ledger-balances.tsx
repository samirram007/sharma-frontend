...
export default function StepLedgerBalances({
  ledgers,
  onNext,
  onBack,
}: StepLedgerBalancesProps) {
              ...
              <table className="w-full text-sm">
                <thead className="sticky top-0 bg-muted/80 backdrop-blur-sm">
                  <tr className="border-b">
                    ...
                    <th className="p-2 text-right font-medium text-muted-foreground w-48">
                      Opening Balance
                    </th>
                  </tr>
                </thead>
                      ...
                      >
                        ...
                        <td className="p-2 text-center">
                          <Badge
                            ...
                            className={cn(
                              'text-xs',
                              getNatureBadge(entry.nature).className,
                            )}
                          >
                            {getNatureBadge(entry.nature).label ||
                              entry.natureType ||
                              '-'}
                          </Badge>
                        </td>
