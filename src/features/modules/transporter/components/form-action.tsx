              ...
              <div className="space-y-4 sm:space-y-5">
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Store core transporter identity, tax, and primary contact
                      details.
                    </p>
                  </div>
                ...
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Capture licensing and vehicle information used for freight
                      movement.
                    </p>
                  </div>
                  <div className="space-y-4">
              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Link the transporter to the proper account group and set
                      its active status.
                    </p>
                  </div>
                  <div className="space-y-4">
