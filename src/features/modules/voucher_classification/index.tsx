...
import {
  voucherClassificationListSchema,
  type VoucherClassificationList,
} from './data/schema'
...
export default function VoucherClassification({
  data,
}: VoucherClassificationProps) {
  return (
