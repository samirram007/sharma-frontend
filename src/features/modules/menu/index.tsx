...
import { MenuListSchema, MenuTreeSchema, type MenuList, type MenuTreeNode } from './data/schema'
import { MenuTreeQueryOptions, useMenuDuplicateMutation } from './data/queryOptions'
...
function countTreeNodes(nodes: MenuTreeNode[]): { total: number; active: number; visible: number } {
  let total = 0
  let active = 0
  let visible = 0
        ...
        <div>
            ...
            <div className='mb-2 flex flex-wrap items-center gap-2'>
                <div ref={searchRef} className='relative flex-1 min-w-[160px] max-w-xs'>
                    ...
                    {showDropdown && (
                        <div className='absolute left-0 right-0 top-full z-20 mt-0.5 overflow-hidden rounded-md border bg-popover shadow-md animate-in fade-in slide-in-from-top-1 duration-150'>
                            ...
                            {/* Divider */}
                            {hasRecent && hasSaved && <div className='border-t border-border/40' />}
                ...
                <div className='flex items-center gap-2 text-[10px] text-muted-foreground ml-auto'>
                    <span className='font-medium text-foreground/70'>{stats.total}</span> items
            ...
            <div className='py-0.5'>
                {filteredTree.length > 0 ? (
                    ...
                    <div className='flex flex-col items-center justify-center py-10 text-muted-foreground'>
                        <p className='text-xs font-medium'>No results match &ldquo;{searchQuery}&rdquo;</p>
...
const VIEW_CONFIG: Record<ViewMode, { icon: React.ElementType; label: string }> = {
            ...
            <Main className='min-w-full'>
                ...
                <div className='mb-3 flex flex-wrap items-center justify-between gap-2'>
                    ...
                    <div className='flex items-center gap-1.5'>
                        ...
                        {viewMode !== 'preview' && viewMode !== 'permissions' && <PrimaryButtons />}
                    </div>
                </div>
